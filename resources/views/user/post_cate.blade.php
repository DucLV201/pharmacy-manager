...
<section class="_1khoi sapphathanh mt-4">
            ...
            <div class="noidung bg-white" style=" width: 100%;">
                <div class="row">
                    ...
                    @foreach($postcates as $cate)
                        <h2 class="header text-uppercase" style="font-weight: 600;">{{$cate->title}}</h2>
                        @endforeach    
                    </div>
                </div>
                ...
                <div class="row row-1">
                    ...
                    <div class="col-1ds">
                        <a href="{{URL::to('/bai-viet/'.$post->id)}}"><img src="{{asset('frontend/images/'.$post->img_title)}}" alt="Image"></a>
        ...
        <div class="container" style="margin-bottom:10px" >
            <div class="noidung bg-white" style=" width: 100%;">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <a href="{{URL::to('/bai-viet/'.$post->id)}}"><img src="{{asset('frontend/images/'.$post->img_title)}}" alt="Image" style="padding: 20px; border-radius: 28px;"></a>
                        </div>
                        <div class="col-8">
                        <div style="padding:20px">
                            ...
                            <a href="{{URL::to('/bai-viet/'.$post->id)}}" class="a_post">
                                <h6>{{$post->title}}</h6>
                            </a>
                            <?php
