...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 10, 2023 lúc 10:22 PM
...
CREATE TABLE `bill_detail` (
  `id` int(11) NOT NULL,
  `id_bill_retail` int(11) DEFAULT NULL,
  `id_product` int(11) DEFAULT NULL,
  `quantity` int(11) DEFAULT NULL,
  `quantity_analysis` int(11) DEFAULT NULL,
...
INSERT INTO `bill_detail` (`id`, `id_bill_retail`, `id_product`, `quantity`, `quantity_analysis`, `form`, `timestamp`) VALUES
(39, 28, 648471, 3, 30, 'Vỉ', '2023-06-08 02:29:28'),
(40, 28, 648469, 1, 1, 'Hộp', '2023-06-08 02:29:28'),
(41, 28, 648472, 1, 1, 'Hộp', '2023-06-08 02:29:28'),
(42, 29, 648476, 2, 20, 'Hộp', '2023-06-08 02:30:05'),
(43, 29, 648467, 1, 1, 'Hộp', '2023-06-08 02:30:05'),
(44, 30, 648466, 7, 7, 'Viên', '2023-06-08 02:30:37'),
(45, 30, 648468, 5, 5, 'Gói', '2023-06-08 02:30:37'),
(46, 31, 648468, 5, 5, 'Gói', '2023-06-08 02:31:57'),
(47, 32, 648468, 1, 30, 'Hộp', '2023-06-08 02:32:29'),
(48, 33, 648479, 3, 3, 'Chai', '2023-06-08 02:33:47'),
(49, 34, 648470, 3, 12, 'Vỉ', '2023-06-08 02:35:16'),
(50, 35, 648470, 2, 64, 'Hộp', '2023-06-08 02:36:54'),
(51, 35, 648468, 5, 5, 'Gói', '2023-06-08 02:36:54'),
(52, 35, 648476, 4, 4, 'Gói', '2023-06-08 02:36:54'),
(53, 36, 648466, 5, 50, 'Vỉ', '2023-06-08 02:37:54'),
(54, 36, 648479, 2, 2, 'Chai', '2023-06-08 02:37:54'),
(56, 38, 648467, 1, 1, 'Hộp', '2023-06-08 02:42:07'),
(57, 38, 648470, 2, 2, 'Viên', '2023-06-08 02:42:07');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `bill_retail`
--

CREATE TABLE `bill_retail` (
  `id` int(11) NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `bill_retail`
--

INSERT INTO `bill_retail` (`id`, `id_invoice`, `timestamp`) VALUES
(28, 1, '2023-06-07 02:29:28'),
(29, 1, '2023-06-03 02:30:05'),
(30, 1, '2023-06-04 02:30:37'),
(31, 1, '2023-06-05 02:31:57'),
(32, 1, '2023-06-06 02:32:29'),
(33, 1, '2023-06-02 00:00:00'),
(34, 1, '2023-06-05 02:35:16'),
(35, 1, '2023-06-08 02:36:54'),
(36, 1, '2023-06-08 02:37:54'),
(38, 1, '2023-06-08 02:42:07');
...
(2, 'Vitamin và khoáng chất', 1, NULL),
...
(1, 1, '2022-05-13 14:30:00', 1, 648466, 400, 0),
(2, 1, '2022-05-13 14:30:00', 2, 648467, 100, 98),
(3, 1, '2022-05-13 14:30:00', 3, 648468, 300, 255),
(4, 1, '2022-05-13 14:30:00', 4, 648469, 100, 98),
(5, 1, '2022-05-13 14:30:00', 5, 648470, 380, 130),
(6, 1, '2022-05-13 14:30:00', 6, 648471, 900, 870),
(7, 1, '2022-05-13 14:30:00', 7, 648472, 40, 39),
(8, 1, '2022-05-13 14:30:00', 8, 648473, 50, 50),
(9, 1, '2022-05-13 14:30:00', 9, 648474, 400, 400),
(10, 1, '2022-05-13 14:30:00', 10, 648475, 900, 900),
(11, 1, '2022-05-13 14:30:00', 11, 648476, 200, 176),
(12, 1, '2022-05-13 14:30:00', 12, 648477, 600, 600),
(13, 1, '2022-05-13 14:30:00', 13, 648478, 300, 300),
(14, 1, '2022-05-13 14:30:00', 14, 648479, 200, 195),
(15, 1, '2022-05-13 14:30:00', 15, 648480, 200, 200),
(16, 1, '2022-05-13 14:30:00', 16, 648481, 100, 100),
(17, 1, '2022-05-13 14:30:00', 17, 648482, 150, 150),
...
(21, 1, '2022-05-13 14:30:00', 21, 648486, 200, 200),
(22, 1, '2022-05-13 14:30:00', 22, 648487, 150, 80),
(23, 1, '2022-05-13 14:30:00', 23, 648488, 150, 150),
(24, 1, '2022-05-13 14:30:00', 24, 648489, 50, 50),
(25, 1, '2023-05-29 13:19:46', 26, 648466, 500, 500),
(26, 1, '2023-05-30 15:09:05', 27, 648466, 1000, 1000);
...
--
-- Đang đổ dữ liệu cho bảng `form_products`
--
...
--
-- Cấu trúc bảng cho bảng `import_request`
--
...
(12, 12, '2', '2023-05-25 18:24:04', 'gần ủy ban nhân dân xã,Xã Hội Hoan,Huyện Văn Lãng,Lạng Sơn', '56799', '0', '30000', 'Tài', '0352485712', 'Thanh toán khi nhận hàng'),
(13, 12, '2', '2023-05-25 18:26:51', 'gần ủy ban nhân dân xã,Xã Hội Hoan,Huyện Văn Lãng,Lạng Sơn', '90800', '0', '30000', 'Tài', '0352485712', 'Đã thanh toán qua VNPay'),
(15, 12, '2', '2023-05-25 18:39:29', 'gần ủy ban nhân dân xã,Xã Hội Hoan,Huyện Văn Lãng,Lạng Sơn', '225200', '0', '30000', 'Tài', '0352485712', 'Đã thanh toán qua VNPay'),
...
(22, 11, '3', '2023-05-31 16:38:33', '132 Nguyễn Tất Thành,Phường Hòa Khánh Bắc,Quận Liên Chiểu,Đà Nẵng', '24100', '0', '16500', 'Đức', '0355284711', 'Thanh toán khi nhận hàng'),
(23, 11, '4', '2023-06-07 09:36:24', '132 Nguyễn Tất Thành,Phường Hòa Khánh Bắc,Chọn Quận/Huyện,Lào Cai', '534300', '0', '16500', 'Đức', '0355284711', 'Huỷ thanh toán'),
(24, 11, '1', '2023-06-07 09:44:20', '132 Nguyễn Tất Thành,Phường Hòa Khánh Bắc,Quận Liên Chiểu,Đà Nẵng', '549500', '0', '16500', 'Đức', '0355284711', 'Đã thanh toán qua VNPay');
...
(22, 648470, 1, '7600', 'Vỉ'),
(23, 648467, 1, '495000', 'Hộp'),
(23, 648470, 3, '7600', 'Vỉ'),
(24, 648467, 1, '495000', 'Hộp'),
(24, 648470, 5, '7600', 'Vỉ');
...
(19, 13, 'Đang giao hàng', '2023-05-30 12:00:00'),
(31, 13, 'Giao thành công', '2023-05-30 12:00:00'),
(32, 12, 'Đang giao hàng', '2023-05-30 12:00:00'),
(33, 15, 'Đang giao hàng', '2023-05-31 04:47:44'),
(34, 15, 'Giao thành công', '2023-05-31 04:48:26'),
(35, 12, 'Giao thành công', '2023-05-31 04:55:15'),
(37, 22, 'Đang xử lý', '2023-05-31 16:38:33'),
(38, 22, 'Người bán từ chối đơn hàng', '2023-05-31 16:40:45'),
(39, 23, 'Đã hủy thanh toán', '2023-06-07 09:38:29'),
(40, 24, 'Đang xử lý', '2023-06-07 09:44:48'),
(41, 24, 'Đang giao hàng', '2023-06-07 09:46:58');
...
(1, '2022-01-01', '2023-06-01', 'CÔNG TY TNHH DƯỢC PHẨM USAPHA', 'Việt Nam', '0352287765'),
(2, '2022-01-01', '2023-08-15', 'MELIPHAR', 'Việt Nam', '0352286765'),
(3, '2022-01-01', '2023-09-03', 'MELIPHAR', 'Việt Nam', '0352286766'),
...
(26, '2023-05-29', '2023-06-15', 'CÔNG TY TNHH DƯỢC PHẨM USAPHA', 'Việt Nam', '0352287765'),
(27, '2023-05-30', '2024-01-23', 'CÔNG TY TNHH DƯỢC PHẨM USAPHA', 'Việt Nam', '0352287765');
...
--
-- Cấu trúc bảng cho bảng `recall_request`
--

CREATE TABLE `recall_request` (
  `id` int(11) NOT NULL,
  `id_product` int(11) DEFAULT NULL,
  `id_product_bath` int(11) DEFAULT NULL,
  `name_supplier` varchar(255) NOT NULL,
...
(1, 'Đức', 'admin@localhost', '0986184719', '$2y$10$vcFRo.uu9V4n.qGZ4Ox8SOeyVQzk0A7G6O3l.X9TmqUY2fR6WCXa.', 1, 0, NULL, NULL, NULL, NULL, NULL, NULL),
(11, 'Nam', 'luuvanduc2206@gmail.com', '0355284711', '$2y$10$pZ9jhh0fLxrr.KXhetb5CeWSSQ3FQrDhcAdbbHX123ydRPOKeRp7q', 0, 0, 203, 1530, 40503, '132 Nguyễn Tất Thành', '2023-05-20 12:34:28', '2023-05-20 12:34:28'),
...
(13, 'Hiếu', 'nguyenvanhieu@gmail.com', '0352284718', '$2y$10$r6F9oJiMJ6sqNYY3Kf5dF.ZHU6NM/CFSzFAERtQ5A00G5HlYh6H/a', 1, 0, NULL, NULL, NULL, NULL, '2023-05-30 01:32:04', '2023-05-30 01:32:04'),
(14, 'Hoàng', 'nguyenvanhoang@gmail.com', '0348184722', '$2y$10$01qBaSVgQ8D2BLe7EZ30UuIB4w0eRSrCOl1HEo8cAlAkniW4qFWiu', 2, 0, NULL, NULL, NULL, NULL, '2023-06-09 09:47:19', '2023-06-09 09:47:19'),
(15, 'Quang', 'doquang@gmail.com', '0978502659', '$2y$10$lrgE4H8HS6pOGb4JUndDQeYGVYe9Zgtui7mzhtjX3eQHApoCsYHzK', 3, 0, NULL, NULL, NULL, NULL, '2023-06-09 09:51:39', '2023-06-09 09:51:39');
...
--
-- Chỉ mục cho bảng `bill_retail`
--
ALTER TABLE `bill_retail`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `coupon`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_coupon_product_bath` (`id_bath`);
...
--
-- Chỉ mục cho bảng `import_request`
--
...
ALTER TABLE `products`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_products_product_cate` (`id_cate`);
...
--
-- Chỉ mục cho bảng `recall_request`
--
...
--
-- AUTO_INCREMENT cho bảng `bill_retail`
--
ALTER TABLE `bill_retail`
...
--
-- AUTO_INCREMENT cho bảng `import_request`
--
ALTER TABLE `import_request`
...
--
ALTER TABLE `products`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=648491;

--
-- AUTO_INCREMENT cho bảng `recall_request`
--
ALTER TABLE `recall_request`
...
--
ALTER TABLE `coupon`
  ADD CONSTRAINT `fk_coupon_product_bath` FOREIGN KEY (`id_bath`) REFERENCES `product_bath` (`id`) ON DELETE CASCADE;

--
-- Các ràng buộc cho bảng `products`
--
ALTER TABLE `products`
  ADD CONSTRAINT `fk_products_product_cate` FOREIGN KEY (`id_cate`) REFERENCES `categories` (`id`) ON DELETE CASCADE;
COMMIT;
